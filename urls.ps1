...
# Invoke-Expression $($(Invoke-WebRequest "https://raw.githubusercontent.com/tedzhangzg/shellscripts/main/urls.ps1" -UseBasicParsing).Content)
...
# Java 8 Runtime x86
$url_java8x86 = "https://javadl.oracle.com/webapps/download/GetFile/1.8.0_331-b09/165374ff4ea84ef0bbd821706e29b123/windows-i586/jre-8u331-windows-i586.exe"
